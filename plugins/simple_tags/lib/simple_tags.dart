...
class SimpleTags extends StatelessWidget {
  ...
  final BoxDecoration? selectedtagContainerDecoration;
  ...
  const SimpleTags({
    ...
    this.selectedtagContainerDecoration,
    this.tagIcon,
    ...
    if (content.isNotEmpty) {
      for (var tag in content) {
        toReturn.add(TagContainer(
          tag: tag,
          tagContainerDecoration: tag == selectedTag
              ? selectedtagContainerDecoration
          ...
          tagTextStyle:
              tag == selectedTag ? selectedtagTextStyle : tagTextStyle,
