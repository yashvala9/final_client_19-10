...
class PlacePicker extends StatefulWidget {
  const PlacePicker({
    ...
    this.searchIcon,
    this.showFloatingResult = true,
    this.locationPinIcon = const Icon(Icons.place, size: 36, color: Colors.red),
    this.leadingIcon,
    this.leadingIconColor,
    this.pickerType = LocationPickerType.Auto,
    this.cardButtonText = "Select here",
    this.cardLocationPinIcon,
    this.isDarkModeEnabled = false,
    this.enablePinShadow = true,
  }) : super(key: key);
...
class _PlacePickerState extends State<PlacePicker> {
  ...
  Widget _buildMap(LatLng initialTarget) {
    return GoogleMapPlacePicker(
      enabledDarkMode: widget.isDarkModeEnabled,
      enablePinShadow: widget.enablePinShadow,
      ...
      showResultInFloatingCard: widget.showFloatingResult,
      cardButtonText: widget.cardButtonText,
      cardLocationPinIcon: widget.cardLocationPinIcon,
      onToggleMapType: () {
