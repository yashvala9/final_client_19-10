                                                                ...
                                                                Column(
                                                                  children: [
                                                                    ...
                                                                    FutureBuilder<
                                                                            int>(
                                                                        future: isPhoto
                                                                            ? _reelRepo.getLikeCountByPhotoId(data.id,
                                                                                controller.token!)
                                                                            : _reelRepo.getLikeCountByReelId(data.id, controller.token!),
                                                                ...
                                                                Column(
                                                                  children: [
                                                                    ...
                                                                    FutureBuilder<
                                                                            int>(
                                                                        future: isPhoto
                                                                            ? _commentRepo.getCommentCountByPostId(data.id,
                                                                                controller.token!)
                                                                            : _commentRepo.getCommentCountByReelId(data.id, controller.token!),
                                                                        builder: (context, snapshot) {
                                                                          return Text(
                                                                            snapshot.hasData
                                                                                ? snapshot.data!.toString()
