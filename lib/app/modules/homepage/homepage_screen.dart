                                                                  ...
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (controller
                                                                        ...
                                                                        Get.to(
                                                                          () =>
                                                                              ProfileDetail(profileModel: data.user),
                                                                        );
                                                                      }
                                                                    },
                                                                    child: isReel
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        children: [
                                                                          ...
                                                                          FutureBuilder<String>(
                                                                              future: _giveawayRepo.getTotalEntryCountByUserId(controller.profileId!, controller.token!),
                                                                              builder: (context, snapshot) {
                                                                                if (!snapshot.hasData) {
                                                                                  return Text(
                                                                                    "0",
                                                                        ...
                                                                        children: [
                                                                          InkWell(
                                                                              ...
                                                                              child: FutureBuilder<bool>(
                                                                                  future: _reelRepo.getLikeFlag(data.id, controller.token!),
                                                                          ...
                                                                          FutureBuilder<int>(
                                                                              future: _reelRepo.getLikeCountByReelId(data.id, controller.token!),
                                                                              builder: (context, snap) {
                                                                                return Text(
                                                                      ...
                                                                      Column(
                                                                        children: [
                                                                          ...
                                                                          FutureBuilder<int>(
                                                                              future: _commentRepo.getCommentCountByReelId(data.id, controller.token!),
                                                                              builder: (context, snapshot) {
                                                                                return Text(
                                                                      ...
                                                                      PopupMenuButton<
                                                                          ...
                                                                          onSelected:
                                                                              (v) {
                                                                            Get.dialog(AlertDialog(
                                                                              title: const Text("Please provide the reason:"),
